                ...
                <div class="basis-full lg:basis-3/5 xl:basis-2/4">
                    <div class="grow flex flex-col lg:py-8">
                        ...
                        <div class="flex items-baseline gap-4 mt-4">
                            <div class="text-pink text-lg md:text-xl font-black">{{ $product->price }}</div>{{--<div class="text-body text-md md:text-lg font-bold line-through">{{ $product->old_price }}</div>--}}
                        </div>
